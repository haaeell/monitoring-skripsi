...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/status-ujian', [JadwalUjianController::class, 'statusUjian'])->name('status-ujian.index');
    Route::put('/status-ujian/{id}', [JadwalUjianController::class, 'updateStatus'])->name('status-ujian.update');
